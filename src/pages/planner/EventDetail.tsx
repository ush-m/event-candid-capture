              ...
              {editing ? (
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2">
                  <input
                    ...
                    className="w-full sm:w-auto text-xl sm:text-2xl font-bold bg-gray-800 border border-gray-700 rounded-lg px-3 py-1 text-white"
                    autoFocus
                  />
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-lg p-4 sm:p-6 mb-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-3">
            <input
              readOnly
              value={getEventUrl()}
              className="flex-1 px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-gray-300 text-sm min-w-0"
            />
            <div className="flex gap-2">
              <button
                onClick={handleCopyUrl}
                className="flex-1 sm:flex-none px-4 py-2 bg-gray-700 hover:bg-gray-600 rounded-lg text-sm font-medium"
              >
                Copy
              </button>
              <button
              ...
              <table className="w-full text-sm min-w-[500px]">
                <thead>
                  <tr className="text-gray-400 border-b border-gray-800">
                    <th className="text-left py-2 px-2 sm:px-3">Contact</th>
                    <th className="text-left py-2 px-2 sm:px-3">Status</th>
                    <th className="text-center py-2 px-2 sm:px-3">Media</th>
                    <th className="text-center py-2 px-2 sm:px-3">Shared</th>
                    <th className="hidden sm:table-cell text-center py-2 px-3">Delivered</th>
                    <th className="hidden md:table-cell text-left py-2 px-3">Joined</th>
                  </tr>
                </thead>
                <tbody>
                  {guests.map((guest) => (
                    <tr key={guest.id} className="border-b border-gray-800/50">
                      <td className="py-2 px-2 sm:px-3">
                        ...
                        <span className="ml-1 sm:ml-2 text-xs sm:text-sm">{guest.contact_value}</span>
                      </td>
                      <td className="py-2 px-2 sm:px-3">
                      ...
                      <td className="py-2 px-2 sm:px-3 text-center">{guest.total_media}</td>
                      <td className="py-2 px-2 sm:px-3 text-center">{guest.shared_media}</td>
                      ...
                      <td className="hidden md:table-cell py-2 px-3 text-gray-400 text-xs">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          {event.status === 'active' && (
            <button
              ...
              disabled={ending}
              className="w-full sm:w-auto px-6 py-3 bg-red-600 hover:bg-red-700 rounded-lg font-medium disabled:opacity-50"
            >
