...
import { signIn } from '../../lib/planner';

export function PlannerLogin() {
    ...
    <div className="min-h-screen bg-black text-white flex items-center justify-center p-6">
      <div className="w-full max-w-md space-y-6">
        <div className="text-center">
          <h1 className="text-2xl font-bold">Planner Login</h1>
          <p className="text-gray-400 mt-2">Manage your events</p>
        </div>
        ...
        <p className="text-center text-gray-400 text-sm">
          ...
          <Link to="/planner/signup" className="text-white hover:underline">
            Sign up
          </Link>
        </p>
      </div>
